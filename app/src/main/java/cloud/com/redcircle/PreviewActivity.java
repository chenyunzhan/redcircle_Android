...
//        setSupportActionBar(toolbar);
    ...
    public void onImageSingleTap(MotionEvent e) {
        ...
        if (topBar.getVisibility() == View.VISIBLE) {
            topBar.setAnimation(AnimationUtils.loadAnimation(PreviewActivity.this, R.anim.show_from_bottom));
            bottomBar.setAnimation(AnimationUtils.loadAnimation(PreviewActivity.this, R.anim.hide2bottom));
            topBar.setVisibility(View.GONE);
            bottomBar.setVisibility(View.GONE);
        } else {
            topBar.setAnimation(AnimationUtils.loadAnimation(PreviewActivity.this, R.anim.hide2bottom));
            bottomBar.setAnimation(AnimationUtils.loadAnimation(PreviewActivity.this, R.anim.show_from_bottom));
