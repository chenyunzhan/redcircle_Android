...
/**
 * Created by zhan on 16/5/6.
 */
public class HttpUtils {
    private static String PATH = RedCircleManager.LOGIN_IN_URL; // 服务端地址
     ...
     * @return
     */
    public static String sendPostMessage(Map<String, String> params,String dataStr,
                                         String encode) {
        StringBuilder stringBuilder = new StringBuilder();
        if ((params != null && !params.isEmpty()) || (dataStr != null)) {
            if (dataStr != null) {
